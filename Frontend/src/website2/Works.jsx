...
export function Works() {
    ...
    const projects = [
        {
            ...
            description:
                "We built a modern, high-performance real estate platform where users can search, compare, and book properties with ease. The site features advanced filters, 3D property views, and inquiry forms.",
            image: imgg,
        ...
        },
        {
            ...
            description:
                "Foodzy is a full-featured restaurant ordering and delivery website that allows customers to browse menus, place orders, and track deliveries online.",
            image: imgg,
        ...
        },
        {
            ...
            description:
                "SkillForge is a responsive e-learning platform that provides video courses, live sessions, and progress tracking for students and professionals.",
            image: imgg,
        ...
        },
        {
            ...
            description:
                "We developed an end-to-end e-commerce website for electronics retail, supporting multiple vendors, product search, and secure transactions.",
            image: imgg,
    ...
    return (
        <>
            <section id="projects">
                <div
                    className={`custom-cursor fixed pointer-events-none hidden ${
                        isHoveringImage ? "cursor-visible" : ""
                    }`}
                    style={{
                ...
                >
                    <div className="cursor-circle w-[60px] h-[60px] rounded-full flex items-center justify-center">
                        <div className="cursor-arrow text-white font-bold text-lg">
                            →
                        </div>
                    </div>
                    <div className="cursor-text absolute top-[70px] left-[50%] bg-black text-white rounded-lg whitespace-nowrap">
                        View Project
                    </div>
                </div>
                ...
                <div className="works-hero" id="our-works">
                    <div className="works-subhero">
                        ...
                        {projects.map((project) => (
                            <div
                                key={project.id}
                                className="works-container flex flex-col items-center justify-center w-[80%] max-w-[500px] bg-slate-200 p-5 rounded-md relative overflow-hidden"
                            >
                                <div className="image-container relative w-[100%] rounded-md overflow-hidden">
                                    <img
                                        ...
                                        onClick={() =>
                                            handleImageClick(project.url)
                                        }
                                        onMouseEnter={() =>
                                            handleImageMouseEnter(project.url)
                                        }
                        ...
                        <div className="reviews">
                            <div className="works-text">
                                ...
                                <p>
                                    At Nexora Group, we combine creativity,
                                    clean code, and cutting-edge technology to
                                    build websites that perform flawlessly
                                    across devices. Every project we deliver
                            ...
                            >
                                ...
                                >
                                    <p className="review-text">
                                        "Nexora Group is simply amazing! Their
                                        expertise in handling complex IT
                                        projects is commendable. I'm extremely
                                        happy with the services they provided.
                                        From scoping out the requirements to
                                        delivering the final version, everything
                                        was smooth. Keep up the good work!"
                                    </p>
                                ...
                                >
                                    <p className="review-text">
                                        "As a customer of Nexora Group, I must
                                        say that their services are top-notch.
                                        The team is professional,
                                        detail-oriented, and very competent. I
                                        am completely satisfied with their work
                                ...
                                >
                                    <p className="review-text">
                                        "I recently worked with Nexora Group and
                                        was delighted with the quality of their
                                        work. They were professional, efficient,
                                        and delivered on time. Their
                                        communication was excellent, and they
                                        kept me updated throughout the project.
                                        Highly recommended for any IT project
                                        you wish to entrust."
                                    </p>
                                    <div className="review-author">
                                ...
                                >
                                    <p className="review-text">
                                        "I recently availed the services of this
                                        company and I must say I'm very
                                        impressed. The quality of work delivered
                                        by Nexora Group is exceptional. They are
                                        professional, efficient, and deliver on
